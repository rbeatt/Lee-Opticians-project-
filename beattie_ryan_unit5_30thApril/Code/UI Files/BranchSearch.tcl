...
#  Jan 15, 2021 03:48:56 PM GMT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 329x242+425+136
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ###################
    place $top.ent45 \
        -in $top -x 0 -relx 0.243 -y 0 -rely 0.413 -width 184 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 0 -relx 0.061 -y 0 -rely 0.413 -width 0 -relwidth 0.152 \
        -height 0 -relheight 0.087 -anchor nw -bordermode ignore 
    place $top.but47 \
        -in $top -x 0 -relx 0.426 -y 0 -rely 0.744 -width 56 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab48 \
        -in $top -x 0 -relx 0.243 -y 0 -rely 0.083 -width 0 -relwidth 0.535 \
        -height 0 -relheight 0.174 -anchor nw -bordermode ignore 
    place $top.but49 \
        -in $top -x 0 -relx 0.79 -y 0 -rely 0.826 -width 50 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent50 \
        -in $top -x 0 -relx 0.243 -y 0 -rely 0.579 -width 184 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab51 \
        -in $top -x 0 -relx 0.091 -y 0 -rely 0.579 -width 0 -relwidth 0.137 \
        -height 0 -relheight 0.087 -anchor nw -bordermode ignore 
